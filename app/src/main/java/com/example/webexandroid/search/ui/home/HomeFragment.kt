...
//                })
                ...
                binding.joinButton.setOnClickListener {
                    ...
                    if(contains=="contains")
                    {
                        ...
                        it.context.startActivity(SpaceDetailActivity.getIntent(it.context, itemModel.callerId,SpaceDetailActivity.Companion.ComposerType.POST_SPACE, null, null,guestUser, "test","test","test"))
                        binding.reqsentButton.visibility=View.GONE
                    }
                    else{
